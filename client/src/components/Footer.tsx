        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="flex gap-4 pt-2">
              ...
              <a href={GMB_URL} target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#EE6C4D] transition-all group" aria-label="Ver en Google Maps">
                <MapPin className="h-5 w-5 text-gray-400 group-hover:text-white" />
              </a>
            </div>
            <a href={GMB_REVIEWS_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm text-gray-400 hover:text-[#EE6C4D] transition-colors mt-4">
